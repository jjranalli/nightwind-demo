    ...
    return (
        <svg 
            ...
            <circle 
                ...
                r="70" 
                fill="currentColor"
                className={`${props.moonColor || 'text-indigo-600'} ${props.moonColorNight || 'dark:text-amber-300'} ${props.transition || ''}`}/>
            <path 
                fillRule="evenodd" 
                clipRule="evenodd" 
                ...
                fill="currentColor"
                className={`${props.sunColor || 'text-amber-300 group-hover:text-indigo-300'} ${props.sunColorNight || 'dark:text-indigo-400 dark:group-hover:text-amber-500'} ${props.transition || ''}`}/>
        </svg>
    )
}
